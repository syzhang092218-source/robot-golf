...
from robot_golf.planner.robot import get_club_init_transform, solve_axis_align_ik
...
def generate_data():
    ...
    robot_id, ball_id, X_WL_pre, v_ball_init = set_simulator(ball_pos)

    n_joints = p.getNumJoints(robot_id)
    club_link_id = n_joints - 1

    joint_pos_pre = solve_axis_align_ik(robot_id, club_link_id, X_WL_pre, v_ball_init)
